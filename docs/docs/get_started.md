...
```shell
uv pip install git+https://github.com/durandtibo/mlev.git
```

To install a specific version:

```shell
uv pip install mlev==0.3.0
```
...
```shell
pip install git+https://github.com/durandtibo/mlev.git
```

To install a specific version:

```shell
pip install mlev==0.3.0
```

## Verifying Installation

After installation, you can verify that mlev is correctly installed by running:

```shell
python -c "import mlev; print(mlev.__version__)"
```
...
To install `mlev` from source, you can follow the steps below.
...
```shell
git clone git@github.com:durandtibo/mlev.git
cd mlev
```
...
If you plan to contribute to mlev, please also install the development tools.
...
See [CONTRIBUTING.md](https://github.com/durandtibo/mlev/blob/main/.github/CONTRIBUTING.md) for
